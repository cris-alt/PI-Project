...
$sql2 = "SELECT count(*) as newnumber FROM review WHERE date between date_sub(now(),INTERVAL 1 WEEK) and now()";
...
if ($result->num_rows > 0 && $result2->num_rows > 0) {
    ...
    <div class="grid-container-numbers">
        ...
        <div class="percentages">
            ...
            <div class="tags">
                <div class="number-label-left"><p style="float: left; padding: 0">New reviews this week</p></div>
                <div class="number-label-right"><p style="float: right; padding: 0">Reviews on the site</p></div>
            </div>
        </div>
