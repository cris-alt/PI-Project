...
$sql2 = "DELETE FROM watchlist WHERE username='$uname' and title='$title'";
...
</style><center><br><br><br><br><br><br><br><br>
 <div class="welcome_banner" style="opacity: 0.7; height: 200px; font-size: 25px; color: whitesmoke">
 The movie has been removed from your watchlist successfuly!<br> We\'re glad you finally got to watch it..</div>
 <br>
